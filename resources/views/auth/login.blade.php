    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="p-8 rounded shadow-md w-full max-w-md">
            ...
            <form method="POST" action="{{ route('login.post') }}">
                ...
                <div class="mb-4">
                    <label for="username" class="block text-gray-700" id="username-label">NIK:</label>
                    <input type="text" name="username" id="username"
                        class="block w-full border border-gray-300 rounded p-2 mt-1" placeholder="NIK" required>
                </div>
                <div class="mb-4">
                    <label for="password" class="block text-gray-700" id="password-label">Password:</label>
                    <input type="password" name="password" id="password"
                        class="block w-full border border-gray-300 rounded p-2 mt-1" placeholder="Password" required>
                </div>
