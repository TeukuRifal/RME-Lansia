...
<div id="sidebar" class="bg-white md:w-64 w-full flex-shrink-0 h-screen justify-start rounded-xl shadow-md transition-transform duration-300 ease-in-out transform -translate-x-full md:translate-x-0">
    ...
    <div class="p-4 font-bold">
        <ul class="space-y-2">
            <li class="py-2 px-4 hover:bg-gray-100 rounded">
                <a href="{{ route('admin.dashboard') }}" class="block transition duration-300 ease-in-out hover:text-cyan-400">
                    Dashboard
                </a>
            </li>
            {{-- <li class="py-2 px-4 hover:bg-gray-100 rounded">
            ...
            <li class="py-2 px-4 hover:bg-gray-100 rounded">
                <a href="{{ route('updatePengaturan') }}" class="block transition duration-300 ease-in-out hover:text-cyan-400">
                    Pengaturan
                </a>
            </li>
            <li class="py-2 px-4 hover:bg-gray-100 rounded">
