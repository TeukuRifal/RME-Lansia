...
<body class="font-sans">
    <div class="flex bg-gradient-to-b from-lightblue to-[#edf5f8]">
        <div class="w-1/2 flex justify-center items-center p-8 md:p-20 mx-10">
            <div class="mx-auto slide-in-up">
                <h1 class="text-4xl font-bold mb-4">Halo, Pengguna</h1>
                <p class="text-3xl mb-8 text-justify leading-10">Jangan lupa untuk terus olahraga dan cek kesehatan ya!! Mau lihat perkembangan lebih lanjut?</p>
                <a href="###" class="btn-3d text-black font-semibold py-2 px-4 rounded-full">Lihat Perkembangan</a>
            </div>
        </div>
        <div class="flex-auto hidden md:flex justify-center items-center">
            <img src="{{ asset('images/Lansia.png') }}" alt="Welcome Image" class="w-full h-auto slide-in float">
        </div>
    </div>
