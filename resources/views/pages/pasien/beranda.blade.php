...
<body class="font-sans">
    <div class="h-screen flex bg-gradient-to-b from-lightblue to-[#ffffff] pt-20 border-gray-200">
        <div class="w-full md:w-1/2 flex justify-center items-center md:p-20 mx-10">
            <div class="mx-auto slide-in-up">
                <h1 class="text-4xl md:text-5xl font-bold mb-4 text-center md:text-left">Halo, {{ $pasien->nama_lengkap }}</h1>
                <p class="text-xl md:text-2xl mb-8 text-justify leading-8">Jangan lupa untuk terus olahraga dan cek kesehatan ya!
                    Mau lihat perkembangan lebih lanjut?</p>
                <a href="#perkembangan" class="btn-3d text-black font-semibold text-lg md:text-2xl py-2 px-6 rounded-full flex items-center justify-center">
                    <i class="bi bi-bar-chart-line mr-2"></i> Lihat Perkembangan
                </a>
            </div>
        </div>
    ...
    <div class="container mx-auto p-4 border my-4 bg-white shadow-md rounded-lg">
        <div class="flex justify-between items-center mb-6">
            ...
            @if ($latestRecord)
                <a href="{{ route('print.pasien', $latestRecord->id) }}"
                    ...
                    <i class="bi bi-printer mr-2"></i> Cetak Riwayat Kesehatan Bulan Ini
                </a>
            @else
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6 mt-5">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($schedules as $schedule)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $schedule->description }}</td>
            ...
            @else
                <p class="text-gray-500">Tidak ada jadwal pemeriksaan yang terdaftar.</p>
            @endif
        </div>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
            ...
            <ul class="list-disc pl-6 text-gray-600">
                <li>Perhatikan kondisi kesehatan Anda secara berkala dan lakukan pemeriksaan rutin sesuai jadwal yang telah ditentukan.</li>
                <li>Jaga pola makan yang seimbang dan hindari konsumsi makanan yang dapat memperburuk kondisi kesehatan.</li>
                <li>Jika Anda memiliki pertanyaan atau kekhawatiran mengenai kesehatan Anda, segera konsultasikan dengan tenaga medis.</li>
            </ul>
        </div>
    </div>
        <script>
