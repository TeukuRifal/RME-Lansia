    ...
    <div class="container mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
        ...
        <div class="bg-blue-200 rounded-lg shadow-md p-6 mb-8">
            <div class="flex items-center">
                <div class=" bg-white rounded-full w-24 h-24 flex items-center justify-center">
                    @if ($pasien->foto)
                        <img src="{{ Storage::url($pasien->foto) }}" alt="Foto Pasien" class="w-full h-auto rounded-full">
                    @else
                        <img src="{{ asset('images/default.png') }}" alt="Foto Default" class="w-full h-auto rounded-full">
                    @endif
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div id="riwayatKesehatanContent" class="hidden">
                ...
                <div class="mb-4">
                    <label for="searchInput" class="block mb-2 text-sm font-medium text-gray-700">Cari Data Riwayat
                        Kesehatan:</label>
                    ...
                    <table id="healthRecordsTable" class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($healthRecords as $record)
                                <tr>
                                    <td class="px-4 py-2 text-sm text-gray-500">{{ $record->record_date->format('d F Y') }}
                                    </td>
