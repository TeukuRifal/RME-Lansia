            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="border-b border-gray-200 mb-6">
                    <ul class="flex justify-around">
                        <li class="mr-2">
                            <a href="#"
                                class="inline-block py-2 px-4 text-blue-600 font-semibold border-b-2 border-blue-600"
                                id="dataDiriTab" onclick="showDataDiri()">Data Diri</a>
                        </li>
                        <li class="mr-2">
                            <a href="#" class="inline-block py-2 px-4 text-gray-600 font-semibold"
                ...
                <div id="dataDiriSection">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" class="w-full px-4 py-2 border rounded-lg" placeholder="Kunjungan" value="{{ $pasien->kunjungan }}" readonly>
                        </div>
                        <div>
                            <label class="block text-gray-700">Nama</label>
                            <input type="text" class="w-full px-4 py-2 border rounded-lg" placeholder="Nama" value="{{ $pasien->nama }}" readonly>
                        </div>
                        <div>
                            <label class="block text-gray-700">NIK</label>
                            <input type="text" class="w-full px-4 py-2 border rounded-lg" placeholder="NIK" value="{{ $pasien->nik }}" readonly>
