...
<div class="container mx-auto p-10 bg-white rounded-lg shadow-md mt-10">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="border-b border-gray-200 mb-6">
            <ul class="flex border-b">
                <li class="mr-1">
                    <a href="#dataDiriContent" class="py-2 px-4 block text-gray-600 font-semibold hover:text-blue-500" id="dataDiriTab">
                        <i class="bi bi-person mr-2"></i> Data Diri
                    </a>
                </li>
                <li class="mr-1">
                    <a href="#riwayatKesehatanContent" class="py-2 px-4 block text-gray-600 font-semibold hover:text-blue-500" id="riwayatKesehatanTab">
                        <i class="bi bi-file-earmark-medical mr-2"></i> Riwayat Kesehatan
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div id="riwayatKesehatanContent" class="hidden">
            <h2 class="text-3xl font-semibold mb-2 mt-8 mb-4">Data Riwayat Kesehatan</h2>

            <div class="mb-4">
                <label for="searchInput" class="block mb-4 text-xl font-medium text-gray-700">Cari Data Riwayat Kesehatan:</label>
            ...
            <div class="mb-4">
                <button id="exportPdfButton" class="px-4 py-2 bg-lightblue text-black rounded-lg font-semibold hover:bg-[#55A6C8]">
                    <i class="bi bi-file-earmark-pdf mr-2"></i> Ekspor ke PDF
                </button>
            </div>
    ...
    <div class="text-center mt-8">
        <a href="mailto:support@example.com" class="bg-[#55A6C8] hover:bg-blue-300 text-white font-bold py-2 px-4 rounded">
            <i class="bi bi-envelope mr-2"></i> Hubungi Dukungan
        </a>
    </div>
</div>
