...
<div class="container mx-auto p-6">
    ...
    <a href="{{ route('superadmin.superadmins.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 inline-block">Tambah Pengguna</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-3 px-4 border-b flex space-x-2">
                        <a href="{{ route('superadmin.superadmins.edit', $superadmin->id) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 rounded">Edit</a>
                        <form action="{{ route('superadmin.superadmins.destroy', $superadmin->id) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
