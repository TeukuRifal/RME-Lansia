            ...
            <div class="pasien">
                ...
                <div class="riwayat bg-white shadow-md rounded-lg overflow-hidden p-4 mb-4">
                    ...
                    <div class="dropdown mb-4">
                        ...
                        <select id="tanggalRekamMedik" class="form-select block w-52 mt-1"
                    ...
                    <form>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            ...
                            <div>
                                <label for="indeksMassaTubuh" class="block text-sm font-bold text-gray-700">Indeks Massa Tubuh:</label>
                            ...
                            <div>
                                <label for="obatFasilitas" class="block text-sm font-bold text-gray-700">Obat yang Diberikan oleh Fasilitas:</label>
