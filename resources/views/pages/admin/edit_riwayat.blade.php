...
@section('content')
    <div class="container mx-auto p-4">
        <form action="{{ route('updateRiwayat', ['record_id' => $riwayat->id ?? '']) }}" method="POST"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" id="record_date" name="record_date"
                        value="{{ $riwayat->record_date ?? old('record_date') }}"
                ...
                <div>
                    ...
                    <input type="text" id="riwayat_ptm_keluarga" name="riwayat_ptm_keluarga"
                        value="{{ $riwayat->riwayat_ptm_keluarga ?? old('riwayat_ptm_keluarga') }}"
                ...
                <div>
                    ...
                    <input type="text" id="riwayat_ptm_sendiri" name="riwayat_ptm_sendiri"
                        value="{{ $riwayat->riwayat_ptm_sendiri ?? old('riwayat_ptm_sendiri') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    <label for="merokok" class="block text-gray-700 font-bold">Merokok</label>
                    <input type="text" id="merokok" name="merokok" value="{{ $riwayat->merokok ?? old('merokok') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    ...
                    <input type="text" id="kurang_aktivitas_fisik" name="kurang_aktivitas_fisik"
                        value="{{ $riwayat->kurang_aktivitas_fisik ?? old('kurang_aktivitas_fisik') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    ...
                    <input type="text" id="kurang_sayur_buah" name="kurang_sayur_buah"
                        value="{{ $riwayat->kurang_sayur_buah ?? old('kurang_sayur_buah') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    ...
                    <input type="text" id="konsumsi_alkohol" name="konsumsi_alkohol"
                        value="{{ $riwayat->konsumsi_alkohol ?? old('konsumsi_alkohol') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    ...
                    <input type="number" id="berat_badan" name="berat_badan"
                        value="{{ $riwayat->berat_badan ?? old('berat_badan') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    ...
                    <input type="number" id="tinggi_badan" name="tinggi_badan"
                        value="{{ $riwayat->tinggi_badan ?? old('tinggi_badan') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="lingkar_perut" name="lingkar_perut"
                        value="{{ $riwayat->lingkar_perut ?? old('lingkar_perut') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    ...
                    <input type="text" id="tekanan_darah" name="tekanan_darah"
                        value="{{ $riwayat->tekanan_darah_sistolik ?? old('tekanan_darah_sistolik') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    <label for="tekanan_darah_sistolik" class="block text-gray-700 font-bold">Tekanan Darah Sistolik</label>
                    <input type="text" id="tekanan_darah_sistolik" name="tekanan_darah_sistolik"
                        value="{{ $riwayat->tekanan_darah ?? old('tekanan_darah') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    <label for="tekanan_darah_sistolik" class="block text-gray-700 font-bold">Tekanan Darah Sistolik</label>
                ...
                <div>
                    ...
                    <input type="number" id="gula_darah_sewaktu" name="gula_darah_sewaktu"
                        value="{{ $riwayat->gula_darah_sewaktu ?? old('gula_darah_sewaktu') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    <label for="gula_darah_puasa" class="block text-gray-700 font-bold">Gula Darah Sewaktu</label>
                    <input type="number" id="gula_darah_puasa" name="gula_darah_puasa"
                        value="{{ $riwayat->gula_darah_puasa ?? old('gula_darah_puasa') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    ...
                    <input type="number" id="kolesterol_total" name="kolesterol_total"
                        value="{{ $riwayat->kolesterol_total ?? old('kolesterol_total') }}"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">
                </div>
                <div>
                    ...
                    <textarea id="masalah_kesehatan" name="masalah_kesehatan"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">{{ $riwayat->masalah_kesehatan ?? old('masalah_kesehatan') }}</textarea>
                </div>
                <div>
                    <label for="obat_fasilitas_kesehatan" class="block text-gray-700 font-bold">Obat dan Fasilitas
                        Kesehatan</label>
                    <textarea id="obat_fasilitas_kesehatan" name="obat_fasilitas_kesehatan"
                        class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200">{{ $riwayat->obat ?? old('obat_fasilitas_kesehatan') }}</textarea>
                </div>
            </div>
            <div class="mt-6">
                <button type="submit"
                    ...
                    Perubahan</button>
                <a href="{{ route('healthHistory', ['patient_id' => $riwayat->patient_id ?? '']) }}"
