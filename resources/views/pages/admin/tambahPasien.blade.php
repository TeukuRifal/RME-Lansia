...
<div class="container mx-auto p-4 ">
    ...
    <form action="{{ route('storePasien') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md max-w-2xl mx-auto">
        @csrf
        @if ($errors->any())
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nik" name="nik" class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200"
                required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="umur" name="umur" class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200"
                required>
        </div>
        <div class="mb-4">
            <label for="jenis_kelamin" class="block text-gray-700 font-bold">Jenis Kelamin</label>
            <select id="jenis_kelamin" name="jenis_kelamin" class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200"
                required>
        ...
        <div class="mb-4">
            ...
            <select id="status_kawin" name="status_kawin" class="w-full p-2 border border-gray-300 rounded mt-1 focus:ring focus:ring-blue-200"
                required>
        ...
        <div class="flex justify-end">
            <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Tambah Pasien</button>
        </div>
    </form>
</div>
